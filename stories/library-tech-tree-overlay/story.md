...
> *(Annotation 2026-08-30: `ldag-citations-are-demoted-out-of-the-dag` has since RETIRED with the
> citation tier itself — ADR-0477 D1 removed `references` from the schema — which strengthens rather
> than weakens the judgment above: the field name the leg cited now survives in no schema, no walk,
> and no contract.)*
>
