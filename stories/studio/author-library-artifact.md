...
> offline backend derives its view at runtime from the library's committed FIXTURE corpus,
...
> Library). This stays a retrospective spec of the original JSON-store era — kept as history, not
> current code.
