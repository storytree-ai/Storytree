...
export const CHAPTER2_ROUND3_TREE_CANDIDATES: readonly Chapter2HeroTreeCandidate[] = Object.freeze([
  ...
  Object.freeze({
    ...
    anchorRule: Object.freeze({
      ...
      maxAnchorResidualPx: 0.5,
      groundRowSpreadPx: 3,
      contactAnchorSpreadPx: 4.4339,
      experimentDeclaredDriftPx: 0,
      framesShifted: 17,
      maxAbsShiftPx: 2,
      bodyCentroidSpreadBeforePx: 3.559,
      bodyCentroidSpreadAfterPx: 6.159,
      bodyCentroidMaxStepBeforePx: 2.1196,
      bodyCentroidMaxStepAfterPx: 2.4302,
    }),
  }),
]);
