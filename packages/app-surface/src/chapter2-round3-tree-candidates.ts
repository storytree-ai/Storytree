...
const CODE_BLENDER_ANCHOR = Object.freeze({ x: 63, y: 118 });
...
const CODE_BLENDER_TREE_TRACK: OrganicPoseTrack = Object.freeze({
  ...
  normalizationMode: 'author-import-time-only',
  depthSlot: 'hero-tree-organic',
  matureFootprint: Object.freeze({ x: 18, y: 0, width: 90, height: 121 }),
  encodedBytes: 24_478,
  decodedRgbaBytes: 1_245_184,
  provenance: Object.freeze({
    prompt:
...
export const CHAPTER2_ROUND3_TREE_CANDIDATES: readonly Chapter2HeroTreeCandidate[] = Object.freeze([
  ...
  Object.freeze({
    ...
    frameCount: 19,
    canvas: Object.freeze({ width: 128, height: 128 }),
    groundAnchor: Object.freeze({ x: 63, y: 118 }),
    budget: Object.freeze({
      encodedBytes: 49_013,
      decodedRgbaBytes: 1_429_504,
      frameCount: 24,
    ...
    anchorRule: Object.freeze({
      ...
      maxAnchorResidualPx: 0.5,
      groundRowSpreadPx: 3,
      contactAnchorSpreadPx: 1.7642,
      experimentDeclaredDriftPx: 0,
      framesShifted: 5,
      maxAbsShiftPx: 1,
      bodyCentroidSpreadBeforePx: 3.0679,
      bodyCentroidSpreadAfterPx: 4.0679,
      bodyCentroidMaxStepBeforePx: 1.2867,
      bodyCentroidMaxStepAfterPx: 1.8064,
    }),
  }),
]);
