// ⚠ UNWIRED — part of retired `check:friction-drain`, which ADR-0311 D2 removed from the gate on
// 2026-08-05. This module is the ceiling core; its entrypoint `check-friction-drain.ts` is
