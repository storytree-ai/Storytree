// ⚠ UNWIRED — part of retired `check:deploy-health`, which ADR-0311 D2 removed from the gate on
// 2026-08-05. This module is the signal classifier; its entrypoint `check-deploy-health.ts` is
