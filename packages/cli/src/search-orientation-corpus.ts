 ...
 * ## What it is for
 *
 * `./library-search-orientation.test.ts` asks this corpus the plain questions a session actually
 * types at the start of a piece of work, and asserts the artifact that ANSWERS each one reaches the
 * top three unfiltered. That is the red-green fence ADR-0464 D3 asks for, and every case in it was
 * RED against the ranker as it stood on 2026-08-27:
 *
...
export const SEARCH_ORIENTATION_CORPUS: readonly OrientationRow[] = [
  {
    "id": "adr-0002",
    "kind": "adr",
    "doc": {
